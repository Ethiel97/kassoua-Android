 ...
 * Use the {@link UserFavsFragment#newInstance} factory method to
...
public class UserFavsFragment extends Fragment {
     ...
     * @return A new instance of fragment UserFavsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static UserFavsFragment newInstance(String param1, String param2) {
        UserFavsFragment fragment = new UserFavsFragment();
    ...
    public static UserFavsFragment Instance() {
        return new UserFavsFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_user_favs, container, false);
...
//        recyclerView.showShimmerAdapter();
        ...
        Call<List<Product>> call2 = apiService.getUsersFavoritesList(user.getId());
